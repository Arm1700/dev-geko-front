...
export default function CoursePage() {
    ...
    return (
        <section className="bgColorArticle relative pb-5">
            {pickedCourse?.id ? (
                <>
                <article className="grid  px-5 max-w-[1200px] mx-[auto] relative" style={{
                    gridTemplateColumns: "70% 1fr"
                }}>
                    <div className="pr-2">
                        <div className="flex flex-col gap-[20px] text-pseudo py-[75px]">
                ...
                <div
                    className="flex flex-col lg:mx-1 mx-5  border-[1px] sticky top-1 mt-8  h-min  gap-[10px] bg-pseudo">
