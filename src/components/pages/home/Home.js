  ...
  return (
    <main>
      ...
      <div className="slider-container  lg:px-20 px-5 py-20">
        <Slider {...settingsForCourses}>
          {coursesArray.map(({ image, id, text }) => {
            return <Course key={id} image={image} text={text} />
          })}
        </Slider>
      </div>
      ...
      <div
        ...
        className="bg-cover bg-no-repeat lg:px-20 px-5 py-10 bg-primary flex flex-wrap lg:justify-evenly justify-center "
      >
