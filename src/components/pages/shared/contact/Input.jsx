  ...
  return placeholder !== 'Message' ? (
    <div>
      <input
        ...
        className={`capitalize appearance-none my-1 block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white ${
