...
export default function Review() {
    const [currentIndex, setCurrentIndex] = useState(Math.floor((reviewsArray.length) / 2));
                ...
                >
                    {reviewsArray.map((review, i) => (
                        <div key={review.id} className="text-center">
                            <img
                                src={review.image}
                                height={i === currentIndex ? "100" :  "80"} // Adjust image size based on index
                                width={i === currentIndex ?  "100" :  "80"}
