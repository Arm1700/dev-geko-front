  ...
  return (
    <main className="flex flex-col items-center">
      <section className="lg:px-20 px-5">
        <h1 className="text-3xl  py-4 font-roboto-slab font-bold text-primeryDark">
          About Us
        </h1>
        <div className="text-center lg:px-20 px-5 py-2 ">
          <h1 className="text-3xl py-2 font-roboto-slab font-bold text-primeryDark">
      ...
      <section className="text-center bg-primaryLight ">
        <div className="lg:px-20 px-5 pt-5">
          <h1 className="text-3xl py-2 font-roboto-slab font-bold text-primeryDark">
        ...
        <div className="flex flex-wrap my-10 content-center items-center justify-center">
      ...
      <section className="lg:px-20 my-16 gap-8 px-5 w-[70%] mid:w-[85%] sm:w-[80%] max:w-[90%]   flex items-start justify-center">
        <BiSolidQuoteLeft className="text-[40px]  text-primary" />
        <p className=" py-2 font-roboto-slab font-normal flex flex-col text-2xl text-primeryDark">
